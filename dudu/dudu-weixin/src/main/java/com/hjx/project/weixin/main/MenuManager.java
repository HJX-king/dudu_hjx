package com.hjx.project.weixin.main;
...
import com.hjx.project.weixin.pojo.Button;
import com.hjx.project.weixin.pojo.CommonButton;
import com.hjx.project.weixin.pojo.ComplexButton;
import com.hjx.project.weixin.pojo.Menu;
import com.hjx.project.weixin.pojo.ViewButton;
 ...
 */
	...
	public final static String REAL_URL="http://myqfhh.natappfree.cc/"; //个人花生壳
	...
	public final static String appSecret = "e9fa18875cc4d7a9eaf8204bfa87996c";
...
//------------------------------------------------------------		
		...
		btn32.setName("版本消息");
		btn32.setType("view");
		btn32.setUrl("https://www.taobao.com./");
